...
const aboutMeTextContent = 'I am a designer & I create awards winning websites maker'
...
formInputs.forEach((input) => {
    input.addEventListener('focus', () => {
        ...
        setTimeout(() => {
            ...
            formHeading.style.color = '#e7be08';
    ...
    input.addEventListener('blur', () => {
        ...
        setTimeout(() => {
            ...
            formHeading.style.color = '#9b0e0e';
            formHeading.style.opacity = '1';
        }, 300);
    })
})
...
setInterval(() => {
    ...
    //end of slideshow for social icons
